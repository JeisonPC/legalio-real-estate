...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_properties_property_type" AS ENUM('casa', 'apartamento', 'oficina', 'local');
  CREATE TYPE "public"."enum_properties_business_type" AS ENUM('venta', 'arriendo');
  CREATE TYPE "public"."enum_properties_estrato" AS ENUM('1', '2', '3', '4', '5', '6');
  ...
  CREATE TABLE "properties" (
  	...
  	"img_width" numeric NOT NULL,
  	"img_height" numeric NOT NULL,
  	"price" numeric NOT NULL,
  	"property_type" "enum_properties_property_type" NOT NULL,
  	"business_type" "enum_properties_business_type" NOT NULL,
  	"featured" boolean DEFAULT false,
  	"bedrooms" numeric NOT NULL,
  	"bathrooms" numeric NOT NULL,
  	"area" numeric NOT NULL,
  	"garages" numeric DEFAULT 0,
  	"estrato" "enum_properties_estrato" NOT NULL,
  ...
  ALTER TABLE "departments" ADD CONSTRAINT "departments_country_id_countries_id_fk" FOREIGN KEY ("country_id") REFERENCES "public"."countries"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "cities" ADD CONSTRAINT "cities_department_id_departments_id_fk" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "departments_country_idx" ON "departments" USING btree ("country_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_properties_business_type";
  DROP TYPE "public"."enum_properties_estrato";`)
}
