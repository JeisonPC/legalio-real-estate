...
const tags = [
  {
    id: 1,
    name: "Arriendos",
    href: "/blog?category=arrendamiento",
  },
  {
    id: 2,
    name: "Contratos",
    href: "/blog?category=legal-inmobiliario",
  },
  {
    id: 3,
    name: "Propietarios",
  ...
  },
  {
    ...
    href: "/blog?category=compra-vivienda",
  },
  {
    id: 5,
    name: "Propiedad horizontal",
    href: "/blog?category=propiedad-horizontal",
  },
];
  ...
  return (
    <div className="tf-sidebar">
      <div className="sidebar-item sidebar-search">
        ...
        <form className="form-search" action="/blog">
          <fieldset>
            <input
              type="text"
              placeholder="Buscar..."
